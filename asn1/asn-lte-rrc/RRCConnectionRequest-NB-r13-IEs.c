 ...
 * 	found in "../lte-rrc/NBIOT-RRC-Definitions.asn"
...
static asn_oer_constraints_t asn_OER_memb_spare_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	22	/* (SIZE(22..22)) */};
static asn_per_constraints_t asn_PER_memb_spare_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_member_t asn_MBR_RRCConnectionRequest_NB_r13_IEs_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_NB_r13_IEs, spare),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_spare_constr_8, &asn_PER_memb_spare_constr_8,  memb_spare_constraint_1 },
		0, 0, /* No default value */
		"spare"
		},
};
