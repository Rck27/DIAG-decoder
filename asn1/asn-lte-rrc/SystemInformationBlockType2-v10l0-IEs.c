...
#include "SystemInformationBlockType2-v10l0-IEs.h"
...
static asn_TYPE_member_t asn_MBR_freqInfo_v10l0_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType2_v10l0_IEs__freqInfo_v10l0, additionalSpectrumEmission_v10l0),
...
static asn_SEQUENCE_specifics_t asn_SPC_freqInfo_v10l0_specs_2 = {
	sizeof(struct SystemInformationBlockType2_v10l0_IEs__freqInfo_v10l0),
	offsetof(struct SystemInformationBlockType2_v10l0_IEs__freqInfo_v10l0, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_multiBandInfoList_v10l0_specs_4 = {
	sizeof(struct SystemInformationBlockType2_v10l0_IEs__multiBandInfoList_v10l0),
	offsetof(struct SystemInformationBlockType2_v10l0_IEs__multiBandInfoList_v10l0, _asn_ctx),
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_6 = {
	sizeof(struct SystemInformationBlockType2_v10l0_IEs__nonCriticalExtension),
	offsetof(struct SystemInformationBlockType2_v10l0_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_v10l0_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType2_v10l0_IEs, freqInfo_v10l0),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType2_v10l0_IEs, multiBandInfoList_v10l0),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType2_v10l0_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_SystemInformationBlockType2_v10l0_IEs_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType2_v10l0_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* freqInfo-v10l0 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* multiBandInfoList-v10l0 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_SystemInformationBlockType2_v10l0_IEs_specs_1 = {
	sizeof(struct SystemInformationBlockType2_v10l0_IEs),
	offsetof(struct SystemInformationBlockType2_v10l0_IEs, _asn_ctx),
	asn_MAP_SystemInformationBlockType2_v10l0_IEs_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_SystemInformationBlockType2_v10l0_IEs_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SystemInformationBlockType2_v10l0_IEs = {
	"SystemInformationBlockType2-v10l0-IEs",
	"SystemInformationBlockType2-v10l0-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1,
	sizeof(asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1)
		/sizeof(asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1[0]), /* 1 */
	asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1)
		/sizeof(asn_DEF_SystemInformationBlockType2_v10l0_IEs_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SystemInformationBlockType2_v10l0_IEs_1,
	3,	/* Elements count */
	&asn_SPC_SystemInformationBlockType2_v10l0_IEs_specs_1	/* Additional specs */
};
