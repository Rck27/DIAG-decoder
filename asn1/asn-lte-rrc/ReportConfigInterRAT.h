...
typedef enum ReportConfigInterRAT__reportSSTD_Meas_r15_PR {
	ReportConfigInterRAT__reportSSTD_Meas_r15_PR_NOTHING,	/* No components present */
	ReportConfigInterRAT__reportSSTD_Meas_r15_PR_release,
	ReportConfigInterRAT__reportSSTD_Meas_r15_PR_refCell
} ReportConfigInterRAT__reportSSTD_Meas_r15_PR;
typedef enum ReportConfigInterRAT__reportSSTD_Meas_r15__refCell {
	ReportConfigInterRAT__reportSSTD_Meas_r15__refCell_pSCell	= 0,
	ReportConfigInterRAT__reportSSTD_Meas_r15__refCell_spare	= 1
} e_ReportConfigInterRAT__reportSSTD_Meas_r15__refCell;
...
typedef struct ReportConfigInterRAT {
	...
	struct ThresholdNR_r15	*b1_ThresholdNR_r15	/* OPTIONAL */;
	struct ThresholdNR_r15	*b2_Threshold2NR_r15	/* OPTIONAL */;
	struct ReportQuantityNR_r15	*reportQuantityCellNR_r15	/* OPTIONAL */;
	long	*maxRS_IndexReport_r15	/* OPTIONAL */;
	struct ReportQuantityNR_r15	*reportQuantityRS_IndexNR_r15	/* OPTIONAL */;
	BOOLEAN_t	*reportOnLeave	/* OPTIONAL */;
	struct ReportConfigInterRAT__reportSSTD_Meas_r15 {
		ReportConfigInterRAT__reportSSTD_Meas_r15_PR present;
		union ReportConfigInterRAT__reportSSTD_Meas_r15_u {
			NULL_t	 release;
			long	 refCell;
		} choice;
...
/* extern asn_TYPE_descriptor_t asn_DEF_refCell_61;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_ReportConfigInterRAT_1[17];
