...
asn_TYPE_member_t asn_MBR_RRCConnectionResume_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRCConnectionResume_v1430_IEs, rrcConnectionResume_v15x0_IEs),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RRCConnectionResume_v15x0_IEs,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionResume_v1430_IEs_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rrcConnectionResume-v15x0-IEs */
};
