...
typedef enum FailureReportSCG_NR_r15__failureType_r15 {
	FailureReportSCG_NR_r15__failureType_r15_t313_Expiry	= 0,
	FailureReportSCG_NR_r15__failureType_r15_randomAccessProblem	= 1,
	FailureReportSCG_NR_r15__failureType_r15_rlc_MaxNumRetx	= 2,
	FailureReportSCG_NR_r15__failureType_r15_maxUL_TimingDiff	= 3,
	FailureReportSCG_NR_r15__failureType_r15_scg_ChangeFailure	= 4,
	FailureReportSCG_NR_r15__failureType_r15_scg_reconfigFailure	= 5,
	FailureReportSCG_NR_r15__failureType_r15_srb3_IntegrityFailure	= 6
