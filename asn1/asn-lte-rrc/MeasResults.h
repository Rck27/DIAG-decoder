...
typedef enum MeasResults__measResultNeighCells_PR {
	...
	MeasResults__measResultNeighCells_PR_measResultNCellListNR_r15
...
typedef struct MeasResults {
	...
	struct MeasResults__measResultNeighCells {
		...
		union MeasResults__measResultNeighCells_u {
			 ...
			 */
			MeasResultCellListNR_r15_t	 measResultNCellListNR_r15;
		} choice;
...
extern asn_TYPE_member_t asn_MBR_MeasResults_1[19];
