...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_v9i0_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType2_v9i0_IEs, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType2_v9i0_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SystemInformationBlockType2_v10l0_IEs,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
