...
static int asn_DFL_2_cmp_2(const void *sptr) {
...
static int asn_DFL_2_set_2(void **sptr) {
...
static int asn_DFL_3_cmp_2(const void *sptr) {
	const FilterCoefficient_t *st = sptr;
...
static int asn_DFL_3_set_2(void **sptr) {
	FilterCoefficient_t *st = *sptr;
...
asn_TYPE_member_t asn_MBR_QuantityConfigRS_NR_r15_1[] = {
	{ ATF_POINTER, 3, offsetof(struct QuantityConfigRS_NR_r15, filterCoeff_RSRP_r15),
		...
		0,
		{ 0, 0, 0 },
		&asn_DFL_2_cmp_2,	/* Compare DEFAULT 2 */
		&asn_DFL_2_set_2,	/* Set DEFAULT 2 */
	...
	{ ATF_POINTER, 2, offsetof(struct QuantityConfigRS_NR_r15, filterCoeff_RSRQ_r15),
		...
		0,
		{ 0, 0, 0 },
		&asn_DFL_3_cmp_2,	/* Compare DEFAULT 2 */
		&asn_DFL_3_set_2,	/* Set DEFAULT 2 */
