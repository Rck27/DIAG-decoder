...
asn_TYPE_member_t asn_MBR_QuantityConfigNR_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QuantityConfigNR_r15, measQuantityCell_r15),
		...
		"measQuantityCell-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct QuantityConfigNR_r15, measQuantityRS_Index_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_QuantityConfigNR_r15_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measQuantityCell-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* measQuantityRS-Index-r15 */
};
